...
// https://v6.docs.ctr-rElectronics.com/en/stable/docs/tuner/tuner-swerve/index.html
public class TunerConstants {
    ...
    // This needs to be tuned to your individual robot
    public static final LinearVelocity kSpeedAt12Volts = MetersPerSecond.of(5.87);//5.87
    ...
    private static final Angle kFrontLeftEncoderOffset = Rotations.of(0.203857421875);
    ...
    private static final int kBackRightEncoderId = 49;
    ...
    /**
     * Swerve Drive class utilizing CTR Electronics' Phoenix 6 API with the srElected device types.
     */
