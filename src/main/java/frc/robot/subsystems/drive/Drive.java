...
public class Drive extends SubsystemBase {
  ...
  public Drive(
    ...
    // Elastic Swerve
    SmartDashboard.putData("Elastic Swerve Drive", new Sendable() {
      @Override
  ...
  public void runVelocity(ChassisSpeeds speeds) {
    ...
    ChassisSpeeds discreteSpeeds = speeds.discretize(0.02); //ChassisSpeeds.discretize(speeds, 0.02)
  ...
  public Pose2d findClosestApriltag() {
    return poseEstimator.getEstimatedPosition().nearest(Arrays.asList(FieldConstants.allApriltagPoses()));
  }

  public void tareRotation() {
    poseEstimator.resetPose(new Pose2d(getPose().getTranslation(), new Rotation2d()));
  }

  public void tareTranslation() {
    poseEstimator.resetPose(new Pose2d(new Translation2d(), getPose().getRotation()));
  }
